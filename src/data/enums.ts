...
export type CargoBuyOp = "BuySystem" | "BuyTrader" | "Plunder";

export type CargoSellOp = "SellSystem" | "SellTrader" | "Dump" | "Jettison";

export const CrewMemberId = {
  NA: -1,
  Commander: 0,
  Alyssa: 1,
  Armatur: 2,
...
export const PoliticalSystemType = {
  Anarchy: 0,
  Capitalist: 1,
  Communist: 2,
  Confederacy: 3,
...
export const VeryRareEncounter = {
  MarieCeleste: 0,
  CaptainAhab: 1,
  CaptainConrad: 2,
  CaptainHuie: 3,
